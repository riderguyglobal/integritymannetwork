          ...
          <Card variant="light" className="overflow-hidden">
            <CardContent className="p-0">
              <div className="grid grid-cols-1 lg:grid-cols-5 gap-0">
                {/* Left */}
                <div className="lg:col-span-2 p-5 sm:p-8 md:p-12 flex flex-col items-start justify-center border-b lg:border-b-0 lg:border-r border-zinc-200">
                  <div className="w-12 h-12 sm:w-16 sm:h-16 rounded-xl sm:rounded-2xl bg-white flex items-center justify-center mb-4 sm:mb-6">
                ...
                {/* Right */}
                <div className="lg:col-span-3 p-5 sm:p-8 md:p-12 space-y-4 sm:space-y-5 text-sm sm:text-base text-zinc-700 leading-relaxed">
