      ...
      <section className="section-padding pt-8">
        <div className="container-wide">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              <div className="aspect-square bg-zinc-800/50 rounded-2xl border border-zinc-800/50 flex items-center justify-center relative overflow-hidden">
                ...
                {[1, 2, 3, 4].map((i) => (
                  <div
                    ...
                    className={`w-20 h-20 rounded-lg border flex items-center justify-center cursor-pointer transition-all ${
                      i === 1
                        ? "border-orange-500/50 bg-zinc-800/50"
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex items-center border border-zinc-700/50 rounded-lg overflow-hidden">
                    <button
                      ...
                      className="p-3 hover:bg-zinc-800 transition-colors text-zinc-400"
                    >
