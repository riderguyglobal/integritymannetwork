      ...
      <section className="relative pt-40 pb-16 overflow-hidden">
        ...
        <div className="container-wide relative z-10">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="max-w-3xl mx-auto">
            <Link href="/blog" className="inline-flex items-center gap-2 text-sm text-zinc-500 dark:text-zinc-400 hover:text-orange-500 dark:hover:text-orange-400 transition-colors mb-8">
            ...
            <h1 className="font-display text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight text-zinc-900 dark:text-white leading-tight mb-6">
      ...
      <section className="section-padding">
        <div className="container-wide">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.2 }} className="max-w-3xl mx-auto">
            <article className="prose prose-zinc dark:prose-invert prose-orange max-w-none">
              <div className="space-y-6 text-zinc-600 dark:text-zinc-300 leading-relaxed text-[17px]">
                <p className="text-xl text-zinc-700 dark:text-zinc-200 leading-relaxed font-medium">
                ...
                <h2 className="text-2xl font-bold text-zinc-900 dark:text-white font-display mt-12 mb-4">What is Eternal Purpose?</h2>
                ...
                <blockquote className="border-l-2 border-orange-500/50 pl-6 italic text-orange-500/80 dark:text-orange-400/80 font-medium text-lg my-8">
                ...
                <h2 className="text-2xl font-bold text-zinc-900 dark:text-white font-display mt-12 mb-4">The Crisis of Misalignment</h2>
                ...
                <h2 className="text-2xl font-bold text-zinc-900 dark:text-white font-display mt-12 mb-4">How The Network Helps</h2>
                ...
                <div className="mt-12 p-6 rounded-xl bg-orange-500/5 border border-orange-500/20">
                  <p className="text-sm text-zinc-500 dark:text-zinc-400">
                    <strong className="text-zinc-900 dark:text-white">Ready to begin your journey?</strong>{" "}
            ...
            {/* Share / Tags */}
            <div className="mt-12 pt-8 border-t border-zinc-200 dark:border-zinc-800/50 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
